  ...
  return (
    <div className="grid grid-cols-[40%_60%] lg:grid-cols-1 lg:py-16">
      ...
      <div className="grid items-center justify-items-center lg:gap-6 min-lg:pl-4">
        ...
        <div className="relative flex flex-col gap-4 self-end lg:self-start h-fit rounded-[80px] md:rounded-[50px] px-12 xxs:px-6 py-8 pt-12 mx-4 max-w-lg bg-white/80 text-black shadow-xl backdrop-blur-md">
